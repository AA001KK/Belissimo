  ...
  return (
    <div>
      <div className="card-container">
        ...
        <div className="cards flex flex-col md:grid md:grid-cols-2  2xl:grid-cols-4 gap-[20px] py-4">
          {pitsaz.map(({ img, title, subtitle, price },ind) => {
            return (
              <div key={ind} className="card cursor-pointer relative xl:justify-between xl:items-start   items-stretch  xl:flex-col  all linear duration-300  justify-start gap-[10px] lg:hover:scale-scaleCard  p-[10px] flex lg:items-center  rounded-[14px]  shadow-shadowCard bg-[#fff]  ">
                <div className="card__img  flex  xl:flex-col items-center">
                  ...
                  <div className="card__info  hidden xl:block  ">
                    <div className="card__info_title text-[13px] lg:text-[18px]">
                      {title}
                    </div>
